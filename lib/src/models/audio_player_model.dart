...
class AudioPlayerModel with ChangeNotifier{
  ...
  String printDuration(Duration duration){
    ...
    String towDigitMinutes = twoDigits(duration.inMinutes.remainder(60));
    String towDigitSeconds = twoDigits(duration.inSeconds.remainder(60));
    // return "${twoDigits(duration.inHours)}:$towDigitMinutes:$towDigitSeconds";
    return "$towDigitMinutes:$towDigitSeconds";
  }
